...
namespace E3Series.Wrapper.Entities
{
    ...
    /// </summary>
    public class E3ExternalDocument : ProxyWrapperBase<E3ExternalDocumentProxy>, IExternalDocument
    {
        public E3ExternalDocument(E3Job job)
            : base(job, () => new E3ExternalDocumentProxy(job.Proxy.CreateExternalDocumentObject()))
        {
        }
