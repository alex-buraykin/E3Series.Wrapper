...
namespace E3Series.Wrapper.Entities
{
    ...
    /// </summary>
    public class E3StructureNode : ProxyWrapperBase<E3StructureNodeProxy>, IStructureNode
    {
        public E3StructureNode(E3Job job)
            : base(job, () => new E3StructureNodeProxy(job.Proxy.CreateStructureNodeObject()))
        {
        }
