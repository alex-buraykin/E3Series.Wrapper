...
namespace E3Series.Wrapper.Entities
{
    ...
    /// </summary>
    public class E3FunctionalUnit : ProxyWrapperBase<E3FunctionalUnitProxy>, IFunctionalUnit
    {
        public E3FunctionalUnit(E3Job job)
            : base(job, () => new E3FunctionalUnitProxy(job.Proxy.CreateFunctionalUnitObject()))
        {
        }
